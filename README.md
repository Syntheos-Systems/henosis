...
| Mode | Contract |
| --- | --- |
| Local | Loopback-only, one operator, SQLite state, embedded compatibility policy, and restart-durable quota and rate-limit counters. The signed compatibility room authorizes `henosis.probe` only. |
