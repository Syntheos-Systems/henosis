...
try {
    ...
    & (Join-Path $repository 'scripts/package-release.ps1') -BinaryPath $binary -Version '0.1.0-alpha.6' -Target 'x86_64-pc-windows-msvc' -OutputDirectory $output -SourceDateEpoch 1784768092 | Out-Null
    ...
    try {
        ...
        foreach ($required in @('henosis-0.1.0-alpha.6-x86_64-pc-windows-msvc/HENOSIS_ARCHIVE', 'henosis-0.1.0-alpha.6-x86_64-pc-windows-msvc/henosis.exe', 'henosis-0.1.0-alpha.6-x86_64-pc-windows-msvc/install.ps1')) {
