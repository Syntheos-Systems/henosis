...
require_line "$REPOSITORY_DIR/install.sh" 'resolve_override VERSION v0.1.0-beta.1'
...
require_line "$REPOSITORY_DIR/install.ps1" "else { 'v0.1.0-beta.1' }"
...
require_line "$REPOSITORY_DIR/crates/syntheos-server/Cargo.toml" 'version = "0.1.0-beta.1"'
require_line "$REPOSITORY_DIR/Cargo.lock" 'version = "0.1.0-beta.1"'
...
require_line "$README" '| sh -s -- --version v0.1.0-beta.1'
...
require_line "$README" "-Version 'v0.1.0-beta.1'"
